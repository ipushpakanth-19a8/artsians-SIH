...
function getLocalFallbackResponse(message: string, role: string, lang: LanguageCode): string {
  ...
  const responses: Record<string, Record<string, string>> = {
    en: {
      price: "To price your handicraft fairly, go to 'Create Bill' in the seller portal. Enter your material, labour, and transportation costs. ShilpSetu (ShilpSetu) will compare with market benchmarks and suggest a fair price range.",
      ...
      default: "Thank you for reaching out! I'm ShilpSetu's AI assistant (powered by ShilpSetu). I can help you with pricing, billing, product listings, marketplace navigation, and more. Please ask me a specific question!",
    },
    hi: {
      price: "अपने हस्तशिल्प की उचित कीमत के लिए, विक्रेता पोर्टल में 'बिल बनाएं' पर जाएं। अपनी सामग्री, श्रम और परिवहन लागत दर्ज करें। शिल्पसेतु (ShilpSetu) बाज़ार बेंचमार्क से तुलना करके उचित मूल्य सुझाएगा।",
      ...
      default: "संपर्क करने के लिए धन्यवाद! मैं शिल्पसेतु (ShilpSetu) का AI सहायक हूं। मैं मूल्य निर्धारण, बिलिंग, उत्पाद सूची और बाज़ार नेविगेशन में आपकी मदद कर सकता हूं।",
    },
    te: {
      price: "మీ చేతివృత్తికి సరసమైన ధర నిర్ణయించడానికి, విక్రేత పోర్టల్‌లో 'బిల్లు తయారు చేయండి'కి వెళ్లండి. మీ ముడిసరుకు, శ్రమ మరియు రవాణా ఖర్చులను నమోదు చేయండి. శిల్పసేతు (ShilpSetu) తగిన ధరను సూచిస్తుంది.",
      ...
      default: "సంప్రదించినందుకు ధన్యవాదాలు! నేను శిల్పసేతు (ShilpSetu) AI సహాయకుడిని. ధర నిర్ణయం, బిల్లింగ్, ఉత్పత్తి జాబితాలు మరియు మార్కెట్ నావిగేషన్‌లో మీకు సహాయం చేయగలను.",
    },
  };
