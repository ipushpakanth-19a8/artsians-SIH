  ...
  const steps = [
    {
      ...
      desc: 'Marginalized craftspeople cannot fill out complex English business forms. ShilpSetu introduces an icon-first, voice-assisted trilingual onboarding flow (English, Hindi, Telugu) with instant demo phone OTP authorization.',
